...
另外建议系统已安装常见中文字体（windows已自带），例如：

- 宋体
- 黑体
- Times New Roman

如果缺少上述工具或字体，模板可能会出现无法编译、参考文献不生成或字体替换异常等问题。
...
> 注意：Overleaf 的免费账户会因为编译资源限制而偶尔出现编译失败的情况，所以我没有上传模板了，建议本地写作，本地编译。
